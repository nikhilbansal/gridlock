    ...
    var timer = (function(){
        ...
        function init() {
            (function(){
                ...
                // if (config.getParam('api_paths.trips') === 'api/demo/trips_hack.json') {
                    hms = '06:00:00';
                // }
            ...
            function timeIncrement() {
                ...
                if (ts_minute !== ts_minute_new) {
                    ...
                    if (hack_type ==='b' && ts_minute == 14) {
                        var x=$('#surge_collected_id').children()[0]
                        $(x).text('Rs. 10/-');
                        $("#surge_collected_id").notify("Surge Collected of Rs. 10/-", { className: "info", position:"top" });
                ...
                timeOutId = setTimeout(timeIncrement, timer_refresh);
            }
            timeIncrement();
        }
    ...
    var vehicle_helpers = (function(){
        ...
        return {
            load: function() {
                ...
                if (hack_type === 'a') {
                    url = 'api/demo/trips_hack_a.json';
                }else if (hack_type === 'b') {
                    url = 'api/demo/trips_hack_b.json';
                }
                url = url.replace(/\[hhmm\]/, hm.replace(':', ''));
